lets work on a new project i mean a new ui here is the ui for the first page You are given a task to integrate an existing React component in the codebase
...
Steps to integrate
 ...
 3. Use lucide-react icons for svgs or logos if component requires them and when click on the code bottom here a visual studio type ui opens here is the coding area prompt You are given a task to integrate an existing React component in the codebase
...
Steps to integrate
 ...
 1. Install external dependencies
 2. Fill image assets with Unsplash stock images you know exist
 3. Use lucide-react icons for svgs or logos if component requires them all the bottom should have this prompt ui You are given a task to integrate an existing React component in the codebase
...
Copy-paste this component to /components/ui folder:
```tsx
apple-liquid-glass-switcher.tsx
"use client";
    ...
    <div className="theme-provider" data-theme={theme}>
      ...
      <article className="article">
        ...
        <p>
          ...
          suscipit, quo nisi eaque deleniti dolorem aperiam deserunt. Animi dolor
          expedita consectetur deserunt, quae id ab.
        </p>
        <p>
        ...
        <p>
          ...
          molestias aliquam ipsa esse optio temporibus dolorem, fugiat
          obcaecati culpa fuga numquam sapiente libero. Impedit maiores
          doloremque iusto autem temporibus! Quam cupiditate officiis possimus,
          ratione quasi nobis rem quidem quibusdam? Ut earum possimus expedita
          culpa nobis suscipit, non minima at dignissimos aut optio eum? Cumque?
        </p>
        <p>
        ...
        <blockquote>Consequatur itaque sit amet consectetur adipisicing elit.</blockquote>
        <p>
        ...
        <p>
          ...
          officiis fugit est quia. Neque, ea aspernatur? Quod voluptas ab aliquid
          saepe id, eos suscipit, autem quae reiciendis omnis veritatis officiis
          culpa doloremque? Reiciendis ea modi quod ducimus culpa omnis aliquid
          non minus ipsam necessitatibus distinctio, aspernatur iure. Nihil
          cupiditate amet officiis eligendi nostrum harum labore porro optio
          obcaecati reiciendis blanditiis quae, perspiciatis voluptatibus
          suscipit enim.
        </p>
        <p className="box">
...
Steps to integrate
 ...
 1. Install external dependencies
 2. Fill image assets with Unsplash stock images you know exist
 3. Use lucide-react icons for svgs or logos if component requires them rest things fill up by yourself make it hackthon winning do all this inside a new folder also use [$figma](/home/ritesh/.codex/skills/figma/SKILL.md) [@canva](plugin://canva@openai-curated) only if needed [$imagegen](/home/ritesh/.codex/skills/.system/imagegen/SKILL.md) 
